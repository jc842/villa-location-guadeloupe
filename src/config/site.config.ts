...
export const siteConfig: SiteConfig = {
  ...
  revive: {
    ...
    zones: {
      mobileSticky: { zoneId: 764, format: "mobileBanner" },
      inContent: { zoneId: 763, format: "mediumRectangle" },
      header: { zoneId: 762, format: "leaderboard" },
      halfPage: { zoneId: 760, format: "halfPage" },
      largeRectangle: { zoneId: 761, format: "largeRectangle" },
      skyscraper: { zoneId: 765, format: "skyscraper" },
    },
  },
